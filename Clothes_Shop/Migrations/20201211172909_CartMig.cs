        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeaturesId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Item_Features_FeaturesId",
                        column: x => x.FeaturesId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Item_Gender_GenderId",
                        column: x => x.GenderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Item_FeaturesId",
                table: "Item",
                column: "FeaturesId");

            migrationBuilder.CreateIndex(
                name: "IX_Item_GenderId",
                table: "Item",
                column: "GenderId");
        }
